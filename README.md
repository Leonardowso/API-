# Aprendizado por Projeto Integrador (API) - Template

Template para os projetos do curso de graduação em Logistica, ensinando na utilização do repositório digital "GitHub". 
